...
//
//             foreach (var p in pickupList) Library.instance.pickupsDict[p.name] = p;
//
//             foreach (var p in particleList) Library.instance.particleDict[p.name] = p;
//
//             foreach (var t in toolEffectsList) Library.instance.toolEffectsDict[t.name] = t;
//         }
//     }
// }